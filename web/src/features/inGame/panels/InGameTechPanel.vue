...
/**
 * @file InGameTechPanel.vue
 *
 * @description
 * 游戏内“科技”面板（科技树界面占位）。
 *
 * 说明：
 * - 当前仅提供占位 UI，用于后续接入科技树系统与科技解锁逻辑。
 * - 该组件不包含权威模拟逻辑。
 *
 * @usage
 * - 父组件可通过 `@developing` 监听点击占位按钮，并弹出“开发中”提示。
 *
 * @provides
 * - 科技树入口占位。
 */
...
<template>
  <div class="panel-root" role="complementary" aria-label="Tech Panel">
    <div class="panel-header">
      <div class="panel-title">科技</div>
    </div>

    <div class="panel-body">
      <button class="placeholder" type="button" @click="emit('developing')">科技树（开发中）</button>
    </div>
  </div>
</template>
