...
/**
 * @file InGameMilitaryPanel.vue
 *
 * @description
 * 游戏内“军事”面板（军事行动界面占位）。
 *
 * 说明：
 * - 当前仅提供占位 UI，用于后续接入舰队指挥与军事行动相关功能。
 * - 该组件不包含权威模拟逻辑。
 *
 * @usage
...
<template>
  <div class="panel-root" role="complementary" aria-label="Military Panel">
    <div class="panel-header">
      <div class="panel-title">军事</div>
    </div>

    <div class="panel-body">
      <button class="placeholder" type="button" @click="emit('developing')">舰队指挥（开发中）</button>
    </div>
  </div>
</template>
