...
- 003-localization-ui-settings: Added Java (LibGDX Framework) + `libgdx`, `gdx-freetype`

- 001-game-framework-cs: Added Java 17 (LibGDX 默认版本) + LibGDX 1.14.0, Kryo (序列化), KryoNet (可选，用于网络通信调研)
