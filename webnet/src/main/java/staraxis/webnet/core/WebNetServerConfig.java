...
public class WebNetServerConfig {
    ...
    public final boolean aiPrestart;
    ...
    public WebNetServerConfig(String host, int port, int autoExitSeconds) {
        this(host, port, autoExitSeconds, true, true, "http://127.0.0.1:5173/");
    }

    public WebNetServerConfig(String host, int port, int autoExitSeconds,
            boolean aiPrestart, boolean serverUiEnabled, String gameUiUrl) {
        this.host = host;
        this.port = port;
        this.autoExitSeconds = autoExitSeconds;
        this.aiPrestart = aiPrestart;
