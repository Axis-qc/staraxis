...
public enum SpectralType {
    ...
    O(0.59f, 0.71f, 1.0f, 200.0, 400.0),

    /** B 型：蓝白色，10000-30000K。 */
    B(0.67f, 0.78f, 1.0f, 100.0, 200.0),

    /** A 型：白色，7500-10000K。 */
    A(0.85f, 0.89f, 1.0f, 60.0, 100.0),

    /** F 型：黄白色，6000-7500K。 */
    F(1.0f, 0.97f, 0.85f, 40.0, 60.0),

    /** G 型：黄色（太阳），5200-6000K。 */
    G(1.0f, 0.92f, 0.60f, 20.0, 40.0),

    /** K 型：橙色，3700-5200K。 */
    K(1.0f, 0.73f, 0.38f, 15.0, 25.0),

    /** M 型：红色（最常见），2400-3700K。 */
    M(1.0f, 0.47f, 0.27f, 5.0, 15.0);
