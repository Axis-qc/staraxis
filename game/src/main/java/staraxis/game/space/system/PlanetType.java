...
public enum PlanetType {
    ...
    /** 岩石行星（灰褐色）。 */
    ROCKY(0.55f, 0.47f, 0.38f, 3.0, 15.0),

    /** 气态巨星（橙黄/条纹）。 */
    GAS_GIANT(0.85f, 0.65f, 0.35f, 40.0, 80.0),

    /** 海洋行星（蓝色）。 */
    OCEAN(0.20f, 0.45f, 0.80f, 5.0, 12.0),

    /** 冰封行星（白色/浅蓝）。 */
    ICE(0.75f, 0.82f, 0.90f, 3.0, 10.0),

    /** 熔岩行星（暗红色）。 */
    LAVA(0.70f, 0.25f, 0.15f, 3.0, 8.0);
